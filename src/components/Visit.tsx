...
export default function Visit() {
  ...
  return (
    <section ref={ref} id="visit" className="bg-background py-24 md:py-32">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-12 gap-10">
