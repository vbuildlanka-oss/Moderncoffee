...
export default function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-[100dvh] flex flex-col justify-end overflow-hidden pt-32 pb-12 md:pb-20"
    >
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
        <div className="lg:col-span-7 relative z-10" data-parallax-text>
          ...
          <h1 className="font-display text-[18vw] lg:text-[10.5vw] leading-[0.92] mt-6 tracking-[-0.04em]">
          ...
          <p
            data-reveal-line
            className="mt-8 max-w-md text-mutedtext text-lg leading-relaxed"
          >
        ...
        <div className="lg:col-span-5 relative h-[55vh] lg:h-[78vh] overflow-hidden rounded-md" data-reveal-media>
          <img
            data-parallax-img
          ...
          <div className="absolute bottom-4 left-4 right-4 flex items-end justify-between text-cream">
            <span className="font-mono-label">N° 001 / Signature Espresso</span>
            <span className="font-display italic text-2xl">est. ’18</span>
          </div>
        </div>
      </div>
    </section>
